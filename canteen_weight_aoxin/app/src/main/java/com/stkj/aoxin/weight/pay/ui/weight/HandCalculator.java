 ...
 * 收银计算器
 */
public class HandCalculator extends FrameLayout {
    ...
    private TextView stv_spot;
    private EditText tvConsume;
    private TextView tvOperateNumber;
    private HorizontalScrollView hsvConsume;
    private OnHandListener onCalculateListener;
    private boolean isCalculatorEnable = true;

    public HandCalculator(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public HandCalculator(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HandCalculator(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        LayoutInflater.from(context).inflate(R.layout.include_hand_calculator_cashier, this);
        ...
        findViewById(R.id.sfl_del).setOnLongClickListener(new OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (onCalculateListener != null) {
                    onCalculateListener.onDeleteLongClickListener();
                }
                return false;
            }
        });
...
//        });
        ...
        stv_spot = findViewById(R.id.stv_spot);
        stv_spot.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!isCalculatorEnable) {
                    AppToast.toastMsg("不可操作,请稍等~");
    ...
    public void setOnCalculateListener(OnHandListener onCalculateListener) {
