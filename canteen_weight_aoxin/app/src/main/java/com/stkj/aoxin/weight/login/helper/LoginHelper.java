package com.stkj.aoxin.weight.login.helper;
...
import com.stkj.aoxin.weight.login.ui.fragment.LoginAlertFragment;
...
//                                  AndroidUtils.restartApp();
    ...
    private void addMainLoginPlaceFragment(MainActivity activity, Fragment fragment) {
        FragmentUtils.safeAddFragment(activity.getSupportFragmentManager(), fragment, com.stkj.aoxin.weight.R.id.fl_login_placeholder);
    }
