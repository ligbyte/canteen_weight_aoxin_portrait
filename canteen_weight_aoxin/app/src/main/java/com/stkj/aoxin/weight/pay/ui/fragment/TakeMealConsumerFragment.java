...
import com.stkj.aoxin.weight.pay.callback.OnGetCanteenTimeInfoListener;
...
import com.stkj.aoxin.weight.pay.model.RefreshConsumerTakeModeEvent;
import com.stkj.aoxin.weight.pay.model.TakeMealListItem;
import com.stkj.aoxin.weight.pay.model.TakeMealListResult;
import com.stkj.aoxin.weight.pay.service.PayService;
import com.stkj.aoxin.weight.pay.ui.adapter.TakeMealViewHolder;
...
public class TakeMealConsumerFragment extends IdentityVerificationFragment implements OnConsumerConfirmListener {
    ...
    private void handleGetMealSuccess(TakeMealListResult takeMealListResult, int consumptionType) {
        if (takeMealListResult.isSuccess() && takeMealListResult.getData() != null && !takeMealListResult.getData().isEmpty()) {
            ...
            try {
                AppApplication.createOrderNumber = takeMealListResult.getData().get(0).getOrderNumber();
