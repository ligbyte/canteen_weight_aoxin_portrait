...
import com.stkj.aoxin.weight.base.utils.JacksonUtils;
import com.stkj.aoxin.weight.pay.data.PayConstants;
import com.stkj.aoxin.weight.pay.model.LocalConsumerRecord;
...
public class PaymentSettingMMKV {
    ...
    public static final String KEY_CHECKBOX_PASSWORD = "key_checkbox_password";
    ...
    public static void putPassword(String username) {
        MMKV mmkv = getMMKV();
        mmkv.putString(KEY_PASSWORD, username);
    }
    ...
    public static void putCheckboxPassword(boolean switchPayTypeCard) {
        MMKV mmkv = getMMKV();
        mmkv.putBoolean(KEY_CHECKBOX_PASSWORD, switchPayTypeCard);
    }

    public static boolean getCheckboxPassword() {
        MMKV mmkv = getMMKV();
        return mmkv.decodeBool(KEY_CHECKBOX_PASSWORD, true);
    }
