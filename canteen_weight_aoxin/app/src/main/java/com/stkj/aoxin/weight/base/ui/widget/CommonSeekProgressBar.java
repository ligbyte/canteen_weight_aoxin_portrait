...
import com.stkj.aoxin.weight.base.callback.SimpleSeekBarChangeListener;
...
public class CommonSeekProgressBar extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray array = context.obtainStyledAttributes(attributeSet, com.stkj.aoxin.weight.R.styleable.CommonSeekProgressBar);
