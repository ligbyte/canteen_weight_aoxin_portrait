...
import com.stkj.aoxin.weight.base.callback.OnUploadLogListener;
...
import com.stkj.aoxin.weight.base.upload.UploadLogHelper;
...
import com.stkj.aoxin.weight.login.callback.LoginCallback;
...
import com.stkj.aoxin.weight.setting.helper.CrashLogHelper;
...
public class TabDeviceSettingFragment extends BaseRecyclerFragment implements OnGetStoreInfoListener, AppUpgradeHelper.OnAppUpgradeListener {
    ...
    protected int getLayoutResId() {
        return com.stkj.aoxin.weight.R.layout.fragment_tab_device_setting;
    }
    ...
    protected void initViews(View rootView) {
        ...
        tvVersionName.setText("慧称重v" + BuildConfig.VERSION_NAME);
